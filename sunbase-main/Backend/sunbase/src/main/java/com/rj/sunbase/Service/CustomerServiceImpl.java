...
public class CustomerServiceImpl implements CustomerService {
	...
	public Page<Customer> searchAndFilterCustomers(String searchTerm, String city, String state, String email,
		...
		Page<Customer> customers = customerRepository.filterAndSearchCustomers(searchTerm, city, state, email,
				pageable);
		if (customers.isEmpty()) {
			throw new CustomerNotFoundException("No customers found matching the given criteria.");
		}
		return customers;
	}
}
